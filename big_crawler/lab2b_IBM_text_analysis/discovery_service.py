...
discovery = watson_developer_cloud.DiscoveryV1(
    '2016-11-07',
    username='9f19e275-2600-4106-ab9e-c83fddbbb7ae',
    password='5fB4Qaayeirf',
...
news_environments = [x for x in environments['environments'] if x['name'] == 'Watson Discovery Newws Environment']
news_environment_id = news_environments[0]['environment_id']
print(json.dumps(news_environment_id, indent=2))
